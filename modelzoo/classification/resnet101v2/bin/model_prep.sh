...
RESNET101V2="resnet101v2_virtual_env"
MODEL_FILE_NAME="resnet101v2"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet101v2 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET101V2}
source ${RESNET101V2}/bin/activate
