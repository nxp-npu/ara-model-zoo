...
RESNET18="resnet18_virtual_env"
MODEL_FILE_NAME="resnet18"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet18 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET18}
source ${RESNET18}/bin/activate
