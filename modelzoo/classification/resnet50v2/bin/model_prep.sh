...
RESNET50V2="resnet50v2_virtual_env"
MODEL_FILE_NAME="resnet50v2"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet50v2 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET50V2}
source ${RESNET50V2}/bin/activate
