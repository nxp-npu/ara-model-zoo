...
RESNET50V1="resnet50v1_virtual_env"
MODEL_FILE_NAME="resnet50v1"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet50v1 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET50V1}
source ${RESNET50V1}/bin/activate
