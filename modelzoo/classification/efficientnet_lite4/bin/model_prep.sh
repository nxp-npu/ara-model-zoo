...
VENV_DIR="${OUTPUT_DIR}/efficientnet_lite4_venv"
MODEL_DIR="${OUTPUT_DIR}/efficientnet_lite4_model"
...
# ─── Download EfficientNet-Lite4 checkpoint ───────────────────────────────────

info "Downloading EfficientNet-Lite4 checkpoint..."
wget "${CHECKPOINT_URL}"
...
info "Exporting EfficientNet-Lite4 to SavedModel format..."
python3 export_model.py \
  --model_name="${MODEL}" \
  --ckpt_dir="efficientnet-lite4" \
...
info "EfficientNet-Lite4 model preparation complete."
