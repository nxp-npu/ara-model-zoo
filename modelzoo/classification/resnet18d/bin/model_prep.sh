...
RESNET18D="resnet18d_virtual_env"
MODEL_FILE_NAME="resnet18d"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet18d repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET18D}
source ${RESNET18D}/bin/activate
