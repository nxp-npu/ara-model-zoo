...
RESNET152V2="resnet152v2_virtual_env"
MODEL_FILE_NAME="resnet152v2"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet152v2 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET152V2}
source ${RESNET152V2}/bin/activate
...
onnx.export(model,dummy_input, "${OUTPUT_DIR}/${ONNX_FILE}" , opset_version=13)
