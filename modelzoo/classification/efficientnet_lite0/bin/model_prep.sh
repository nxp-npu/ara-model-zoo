...
VENV_DIR="${OUTPUT_DIR}/efficientnet_lite0_venv"
MODEL_DIR="${OUTPUT_DIR}/efficientnet_lite0_model"
...
# ─── Download EfficientNet-Lite0 checkpoint ───────────────────────────────────

info "Downloading EfficientNet-Lite0 checkpoint..."
wget "${CHECKPOINT_URL}"
...
info "Exporting EfficientNet-Lite0 to SavedModel format..."
python3 export_model.py \
  --model_name="${MODEL}" \
  --ckpt_dir="efficientnet-lite0" \
...
info "EfficientNet-Lite0 model preparation complete."
