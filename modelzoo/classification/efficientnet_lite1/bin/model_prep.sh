...
VENV_DIR="${OUTPUT_DIR}/efficientnet_lite1_venv"
MODEL_DIR="${OUTPUT_DIR}/efficientnet_lite1_model"
...
# ─── Download EfficientNet-Lite1 checkpoint ───────────────────────────────────

info "Downloading EfficientNet-Lite1 checkpoint..."
wget "${CHECKPOINT_URL}"
...
info "Exporting EfficientNet-Lite1 to SavedModel format..."
python3 export_model.py \
  --model_name="${MODEL}" \
  --ckpt_dir="efficientnet-lite1" \
...
info "EfficientNet-Lite1 model preparation complete."
