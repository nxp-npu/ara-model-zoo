...
VENV_DIR="${OUTPUT_DIR}/efficientnet_lite2_venv"
MODEL_DIR="${OUTPUT_DIR}/efficientnet_lite2_model"
...
# ─── Download EfficientNet-Lite2 checkpoint ───────────────────────────────────

info "Downloading EfficientNet-Lite2 checkpoint..."
wget "${CHECKPOINT_URL}"
...
info "Exporting EfficientNet-Lite2 to SavedModel format..."
python3 export_model.py \
  --model_name="${MODEL}" \
  --ckpt_dir="efficientnet-lite2" \
...
info "EfficientNet-Lite2 model preparation complete."
