...
RESNET101V1="resnet101v1_virtual_env"
MODEL_FILE_NAME="resnet101v1"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet101v1 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET101V1}
source ${RESNET101V1}/bin/activate
