...
RESNET50D="resnet50d_virtual_env"
MODEL_FILE_NAME="resnet50d"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet50d repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET50D}
source ${RESNET50D}/bin/activate
