...
RESNET34="resnet34_virtual_env"
MODEL_FILE_NAME="resnet34"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet34 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET34}
source ${RESNET34}/bin/activate
