...
gdown https://drive.google.com/uc?id= --output $OUTPUT_DIR/compiled_model/model.onnx

info "Downloading pytorch version of the model"
gdown https://drive.google.com/uc?id= --output $OUTPUT_DIR/compiled_model/model.pt
