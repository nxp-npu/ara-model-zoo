...
# ─── Constants ───────────────────────────────────────────────────────────────
# Shared, pre-quantized assets produced by the quantization flow. The optimized
# compile flow consumes these directly instead of exporting from timm.

OPTIMIZED_SRC_DIR="/auto/share/sw/common/modelzoo_eng/optimized_models/classification/Vit_base_Patch16_224"
