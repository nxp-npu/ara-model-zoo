...
RESNET152V1="resnet152v1_virtual_env"
MODEL_FILE_NAME="resnet152v1"
...
_model_prep_cleanup() {
  info "Cleaning up temporary Resnet152v1 repository..."
...
unset PYTHONPATH
virtualenv -p python3 ${RESNET152V1}
source ${RESNET152V1}/bin/activate
