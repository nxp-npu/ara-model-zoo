...
info "Exporting yolov8x to ONNX..."
python3 <<HEREDOC
...
if [[ ! -f "${YOLOV8_REPO}/yolov8x.onnx" ]]; then
  error "ONNX export failed: ${YOLOV8_REPO}/yolov8x.onnx was not created"
  return 1
fi

mv "${YOLOV8_REPO}/yolov8x.onnx" "${ONNX_OUTPUT}"
