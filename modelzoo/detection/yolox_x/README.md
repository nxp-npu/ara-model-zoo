...
```bash
cd ara-model-zoo
./flows/precompiled_model_download.sh model=yolox_x
```

- Precompiled models are compiled using Ara SDK.
- Output model and assets will be stored in the `modelzoo/detection/yolox_x/output/assets` folder

#### Model Compile

```bash
cd ara-model-zoo
./flows/model_compile.sh model=yolox_x dataset_root=<path to val2017>
```

- Output model and assets will be stored in the `modelzoo/detection/yolox_x/output/compiled_model` folder
...
```bash
cd ara-model-zoo
./flows/infer_float.sh images_folder=../images model=yolox_x
./flows/infer_hw.sh images_folder=../images model=yolox_x
```

- Output images saved in `modelzoo/detection/yolox_x/output/postprocessed_output_visualized`
...
```bash
cd ara-model-zoo
./flows/eval_float.sh dataset_root='../coco2017/' model=yolox_x
./flows/eval_hw.sh dataset_root='../coco2017/' model=yolox_x
```
