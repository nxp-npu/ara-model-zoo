...
YOLOV7X="yolov7x_virtual_env"
YOLOV7X_REPO="yolov7x_repo"
MODEL_FILE_NAME="yolov7x"
...
_model_prep_cleanup() {
  info "Cleaning up temporary yolov7x repository..."
  cd $OUTPUT_DIR
...
unset PYTHONPATH
virtualenv -p python3 ${YOLOV7X}
source ${YOLOV7X}/bin/activate
...
git clone https://github.com/WongKinYiu/yolov7.git $YOLOV7X_REPO
cd $YOLOV7X_REPO

wget https://github.com/WongKinYiu/yolov7/releases/download/v0.1/yolov7x.pt
python3 export.py --weights yolov7x.pt --grid \
