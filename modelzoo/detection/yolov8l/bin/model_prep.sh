...
info "Exporting yolov8l to ONNX..."
python3 <<HEREDOC
...
if [[ ! -f "${YOLOV8_REPO}/yolov8l.onnx" ]]; then
  error "ONNX export failed: ${YOLOV8_REPO}/yolov8l.onnx was not created"
  return 1
fi

mv "${YOLOV8_REPO}/yolov8l.onnx" "${ONNX_OUTPUT}"
