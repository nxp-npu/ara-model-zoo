...
info "Exporting yolov8m to ONNX..."
python3 <<HEREDOC
...
if [[ ! -f "${YOLOV8_REPO}/yolov8m.onnx" ]]; then
  error "ONNX export failed: ${YOLOV8_REPO}/yolov8m.onnx was not created"
  return 1
fi

mv "${YOLOV8_REPO}/yolov8m.onnx" "${ONNX_OUTPUT}"
