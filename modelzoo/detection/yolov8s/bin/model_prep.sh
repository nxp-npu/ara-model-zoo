...
info "Exporting yolov8s to ONNX..."
python3 <<HEREDOC
...
if [[ ! -f "${YOLOV8_REPO}/yolov8s.onnx" ]]; then
  error "ONNX export failed: ${YOLOV8_REPO}/yolov8s.onnx was not created"
  return 1
fi

mv "${YOLOV8_REPO}/yolov8s.onnx" "${ONNX_OUTPUT}"
