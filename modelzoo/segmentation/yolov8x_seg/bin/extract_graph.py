...
def main() -> None:
    ...
    # Fix shapes after extraction
    pre_model = onnx.load(str(output_dir / "preprocessing.onnx"))
    pre_model = shape_inference.infer_shapes(pre_model)
    onnx.save(pre_model, str(output_dir / "preprocessing.onnx"))
    ...
    # Fix shapes after extraction
    post_model = onnx.load(str(output_dir / "postprocessing.onnx"))
    post_model = shape_inference.infer_shapes(post_model)
    onnx.save(post_model, str(output_dir / "postprocessing.onnx"))
